        ...
        if((strcmp(token, "+")==0 || strcmp(token, "-")== 0 || strcmp(token, "*")== 0)){
            ...
            if(!isEmpty()){
               ...
               if(isFunc(temp2)){
                  ...
                  if(isFunc(peek())){
                     char* functemp = temps[256-i];
                     while (isFunc(peek()))
                     {  
                        strcat(functemp, " ( ");
                        strcat(functemp, pop());
                        strcat(functemp, " ( ");
                        strcat(functemp , temp2);
                        strcat(functemp, " ");
                        strcat(functemp, temp1);
                        strcat(functemp, " ) ");
                        strcat(functemp, " ) ");
                     }
                     temp3 = pop();
               ...
               // one function
                     ...
                     if (isNumber(temp3)){
                        ...
                        temp3type = varTypes[find(temp3,varNames)];
                     }
                     if(strcmp(temp3type , "scalar")){
                        if(strcmp(temp3type , "scalar")){
